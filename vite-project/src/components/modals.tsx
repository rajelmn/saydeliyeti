...
export function SellModal({medicamentObj, handleSell,setSelledMed }:SellModalProps )  {
    ...
    return(
        ...
        <div className="flex justify-between items-center">
            <h1 className="text-base font-bold">Sell {medicamentObj.medicament}</h1>
            <Close className="text-xl cursor-pointer" onClick={() => setSelledMed(null)}/>
          </div>
